...
class UserApi{
  ...
  Future<DataResult<bool>> saveUser(WidgetRef ref,UserBody user) async{
    String url = "/api/v1/users/new";
    var response = await AuthRequestUtils.post(ref, url, user.toJson());
    DataResult<bool> result = DataResult.fromResponse(response: response);
    return result;
  }
}